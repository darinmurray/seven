...
class ExpenseCategoriesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create expense_category" do
    assert_difference("ExpenseCategory.count") do
      post expense_categories_url, params: { expense_category: { active: @expense_category.active, description: @expense_category.description, name: @expense_category.name, universal: @expense_category.universal, user_id: @expense_category.user_id } }
    end
  ...
  test "should update expense_category" do
    patch expense_category_url(@expense_category), params: { expense_category: { active: @expense_category.active, description: @expense_category.description, name: @expense_category.name, universal: @expense_category.universal, user_id: @expense_category.user_id } }
